...
$config = [
    ...
    'components' => [
        ...
        'mailer' => [
            ...
            'useFileTransport' => env('MAIL_FILETRANSPORT',true),
            'transport'=>[
            ...
            'messageConfig' => [
                'charset' => 'UTF-8',
                'from' => env('FROM_EMAIL','admin@example.com')
            ]
        ],
...
if (YII_ENV_PROD) {
    $config['components']['log']['targets']['email'] = [
        ...
        'levels' => ['error', 'warning'],
        'message' => ['from' => env('FROM_EMAIL'), 'to' => env('ADMIN_EMAIL')]
    ];
...
if (YII_ENV_DEV) {
    ...
    $config['components']['db'] =[
            ...
            'tablePrefix' => env('LOCAL_DB_TABLE_PREFIX'),
            'charset' => 'utf8',
