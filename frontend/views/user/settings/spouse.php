...
<div class="content">
    <h2>Personal Information - Spouse</h2>

    <?php $form = ActiveForm::begin([
        'options' => ['class' => 'ui form success segment'],
    ]) ?>

    <h3 class="marital-status">Marital Status: </h3>


    <?=$form->field($profile, 'marital_status', [
        'template'     => '{label} <div class="field">{input}{error}{hint}</div>',
    ])->dropDownList([
        'Unmarried'                                                                             => 'Unmarried',
        'Married and my spouse is NOT a U.S. citizen or a U.S. Lawful Permanent Resident (LPR)' => 'Married and my spouse is NOT a U.S. citizen or a U.S. Lawful Permanent Resident (LPR)',
        'Married and my spouse IS a U.S. citizen or a U.S. Lawful Permanent Resident (LPR)'     => 'Married and my spouse IS a U.S. citizen or a U.S. Lawful Permanent Resident (LPR)',
        'Divorced'                                                                              => 'Divorced',
        'Widowed'                                                                               => 'Widowed',
        'Legally separated'                                                                     => 'Legally separated',
    ], ['class' => 'ui dropdown selection', 'prompt' => 'Please select'])->label(false)?>


        <br>
        <div class="alert alert-warning">Please Note: If you are married and you fail to list your spouse in the registration, it will result in your disqualification from the program! You will not be issued a Green Card if you win the Green Card Lottery.
        </div>

        <div class="married inactive">
            ...
            <?=$form->field($spouse, 'last_name', ['inputOptions' => ['placeholder' => 'Enter Your Last Name']])?>

            <?=$form->field($spouse, 'gender', [
                'template'     => '{label} <div class="field">{input}{error}{hint}</div>',
                'inputOptions' => [
                    'placeholder' => 'Gender',
                ],
            ...
            <?=$form->field($spouse, 'birthdate_month', [
                'template'     => '{label} <div class="field">{input}{error}{hint}</div>',
                'inputOptions' => [
                    'placeholder' => 'Month',
                ],
            ...
            <?=$form->field($spouse, 'birthdate_day', [
                'template'     => '{label} <div class="field">{input}{error}{hint}</div>',
                'inputOptions' => [
                    'placeholder' => 'Day',
                ],
            ...
            <?=$form->field($spouse, 'birthdate_year', [
                'template'     => '{label} <div class="field">{input}{error}{hint}</div>',
                'inputOptions' => [
                    'placeholder' => 'Year',
                ],
            ])->dropDownList(YearsGenerator::generate(), ['class' => 'ui dropdown selection', 'prompt' => 'Year'])
                    ->label(false)?>

            <h3>Mailing Address</h3>

            <?=$form->field($spouse, 'city_of_birth', ['inputOptions' => ['placeholder' => 'City/Town']])->label(false)?>

            <div class="form-group">
                <div id="mailing-country-dropdown" class="ui fluid search selection dropdown">
                    <input type="hidden" name="Person[country-foo]">
                    <i class="dropdown icon"></i>
                    <input class="search" tabindex="0">
                    <div class="<?php if ( ! Constants::isInCountryList($spouse->country_of_birth)) echo "default"; ?> text"><?php echo ( ! empty($spouse->country_of_birth) && Constants::isInCountryList($spouse->country_of_birth)) ? Constants::getCountryFlagHtml($spouse->country_of_birth) . $spouse->country_of_birth : 'Select Country'; ?></div>
                    <div class="menu" tabindex="-1">
                        ...
                        <div class="item" data-value="British Virgin Islands">
                        ...
                        <div class="item" data-value="Central African Republic">
                        ...
                        <div class="item" data-value="Dominican Republic"><i class="do flag"></i>Dominican Republic
                        </div>
                        ...
                        <div class="item" data-value="French Territories"><i class="tf flag"></i>French Territories
                        </div>
                        ...
                        <div class="item" data-value="Indian Ocean Territory">
                        ...
                        <div class="item" data-value="Netherlands Antilles"><i class="an flag"></i>Netherlands Antilles
                        </div>
                        ...
                        <div class="item" data-value="Northern Mariana Islands">
                        ...
                        <div class="item" data-value="Saint Kitts and Nevis">
                        ...
                        <div class="item" data-value="United Arab Emirates"><i class="ae flag"></i>United Arab Emirates
                        </div>
            ...
            <?php //echo $form->field($spouse, 'country_of_birth', ['inputOptions' => ['placeholder' => 'Country']])->label(false)?>

            <label for="Profile[current_country]">If you can't find the country in the above list, please type it
                here:</label>
            <div class="ui input field">
                <input type="text" name="Person[country_of_birth]"
                       value="<?php if ( ! Constants::isInCountryList($spouse->country_of_birth)) echo $spouse->country_of_birth; ?>"
                       placeholder="Country">
            </div>
