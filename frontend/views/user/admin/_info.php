...
<table class="table">
    <tr>
        ...
        <td>
            ...
            <?=Carbon::createFromTimestamp($user->created_at)->toDateTimeString()?>
        </td>
    </tr>
    ...
    <tr>
        ...
        <?php if ($user->isConfirmed): ?>
            <td class="text-success">
                ...
                <?=Carbon::createFromTimestamp($user->confirmed_at)->toDateTimeString();?>
            </td>
        <?php else: ?>
    ...
    <tr>
        ...
        <?php if ($user->isBlocked): ?>
            <td class="text-danger">
                ...
                <?=Carbon::createFromTimestamp($user->blocked_at)->toDateTimeString()?>
            </td>
        <?php else: ?>
